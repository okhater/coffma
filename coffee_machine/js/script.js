        ...
        bills[i].onmousedown = function(event){
          ...
          document.onmouseup = function(){
            ...
            if (bill_top>bill_acc_top && bill_right<bill_acc_right && bill_left>bill_acc_left && bill_top<bill_acc_bottom){
              ...
              balance.innerText = "Р’Р°С€ Р±Р°Р»Р°РЅСЃ: "+money.value+"СЂСѓР±.";
        ...
        if (money.value >= cost){
          ...
          let timerId = setInterval(function(){
            ...
            if (w==105){
              ...
              displayInfo.innerText = `РљРѕС„Рµ ${coffeeName} РіРѕС‚РѕРІ!`;
              blocker.style.height = 0+"px";
              clearInterval(timerId);
            }else if (w<40){
              displayInfo.innerHTML = `<i class="fas fa-hourglass-start"></i> РѕР¶РёРґР°Р№С‚Рµ...`;
            }else if (w<75){
              displayInfo.innerHTML = `<i class="fas fa-hourglass-half"></i> РѕР¶РёРґР°Р№С‚Рµ...`;
            }else{
              displayInfo.innerHTML = `<i class="fas fa-hourglass-end"></i> РѕР¶РёРґР°Р№С‚Рµ...`;
            }
          },100);
          ...
          displayInfo.innerText = "РќРµС‚ РґРµРЅРµРі - РЅРµС‚ РєРѕС„Рµ!";
      }
      
      function getChange(num,isRecursion=false){
        money.value = 0;
        balance.innerText = "Р’Р°С€ Р±Р°Р»Р°РЅСЃ: "+0+"СЂСѓР±.";
        let coin = 0;
